...
html_logo = "./_static/img/logo-project-black.png"
...
#        '_static/css/bootstrap-sphinx.css'
       './_static/css/bootswatch-3.3.7/sandstone/bootstrap.min.css'
...
latex_documents = [
  ('index', 'MyProject.tex', u'My Project',
   u'Andrés R. Masegosa, Rafael Cabañas', 'manual'),
]
...
man_pages = [
    ('index', 'myproject', u'My Project',
     [u'Andrés R. Masegosa, Rafael Cabañas'], 1)
]
...
texinfo_documents = [
  ('index', 'MyProject', u'My Project',
   u'Andrés R. Masegosa, Rafael Cabañas', 'MyProject', 'One line description of project.',
   'Miscellaneous'),
]
